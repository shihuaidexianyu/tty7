...
pub const RELEASE_BASE: &str = crate::core::distribution::RELEASE_DOWNLOAD_BASE;
...
mod tests {
    ...
    fn download_urls_point_at_the_release_the_tag_names() {
        assert_eq!(
            ...
            "https://github.com/shihuaidexianyu/tty7/releases/download/v26.7.5/tty7-server-linux-x86_64-musl"
        );
        assert_eq!(
            download_url(&release_tag("26.7.6-nightly.20260727"), CHECKSUMS_ASSET),
            "https://github.com/shihuaidexianyu/tty7/releases/download/nightly/checksums.txt"
        );
    }
